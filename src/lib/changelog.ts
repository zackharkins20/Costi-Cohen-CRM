...
export const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  ...
  },
  {
    ...
    description: 'New to The Exchange? Take an interactive tour that highlights key features and shows you around the interface. Available anytime from Settings.',
  ...
  },
  {
    ...
    description: 'Compose, send, and track emails directly from The Exchange. Link emails to deals and contacts, use templates, and view full conversation threads.',
